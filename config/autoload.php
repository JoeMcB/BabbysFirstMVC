...
class AutoLoader{
	public static function load($classname){
		...
		}elseif(file_exists(ROOT_DIR."/controllers/".str_replace("controller", "", $classname).".controller.php")){
			include_once(ROOT_DIR."/controllers/".str_replace("controller", "", $classname).".controller.php");
		}
	}
